                    ...
                    <input type="hidden" name="businessId" value="<?php echo $business->getBusinessId(); ?>">
                         ...
                         <div class="col-lg-4">
                              <div class="form-group">
                                   ...
                                   <textarea name="businessInfo" min= 1 value="<?php echo $business->getBusinessInfo(); ?>" placeholder="<?php echo $business->getBusinessInfo(); ?>" class="form-control" Required cols="30" rows="10"></textarea>
                              </div>
                         </div>
                    </div>
